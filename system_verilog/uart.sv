...
//////////////BAUD GENERATOR//////////////
module baud_generator #(parameter int master_clk=50000000,baud=9600)(input logic clk,reset,output logic baud_tick);
  
  logic [15:0] count;
  
  localparam int max_count=master_clk/(baud*16);
...
module uart_tx(
  input logic clk,reset,baud_tick,tx_start,
  input logic [7:0] tx_data,
  output logic tx_pin,tx_done);
...
module uart_rx(
  input logic clk,reset,baud_tick,rx_pin,
  output logic [7:0] rx_data,
